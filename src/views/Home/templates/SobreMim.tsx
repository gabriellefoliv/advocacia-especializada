    ...
    return(
        <div className='mt-4 md:-mt-52 md:mx-20 md:p-10 flex md:flex-row flex-col justify-content items-center'>
            ...
            <div className='m-8 p-0 md:m-12 md:p-10 flex flex-col text-justify'>
                ...
                <p className='opacity-70 font-bold py-2'>Nossa equipe é formada por profissionais altamente qualificados e dedicados à constante atualização, incorporação e melhoria no serviço oferecido com inovações tecnológicas, assegurando um atendimento eficiente e humanizado.</p>
            </div>
        </div>
    )
}
